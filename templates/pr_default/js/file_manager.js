 ...
 */
var IMG_FOLDER_CLOSE   = "../../user_data/packages/pr_default/img/admin/contents/folder_close.gif";		// フォルダクローズ時画像
var IMG_FOLDER_OPEN    = "../../user_data/packages/pr_default/img/admin/contents/folder_open.gif";		// フォルダオープン時画像
var IMG_PLUS           = "../../user_data/packages/pr_default/img/admin/contents/plus.gif";				// プラスライン
var IMG_MINUS          = "../../user_data/packages/pr_default/img/admin/contents/minus.gif";				// マイナスライン
var IMG_NORMAL         = "../../user_data/packages/pr_default/img/admin/contents/space.gif";				// スペース
