...
<a href="kiyaku.php?transactionid=<!--{$smarty.get.transactionid}-->" accesskey="1"><!--{1|numeric_emoji}-->会員規約を読む<br>
<a href="index.php?transactionid=<!--{$smarty.get.transactionid}-->" accesskey="2"><!--{2|numeric_emoji}-->同意して登録へ<br>
<a href="<!--{$smarty.const.MOBILE_URL_SITE_TOP}-->&PHPSESSID=<!--{$smarty.get.PHPSESSID}-->&transactionid=<!--{$smarty.get.transactionid}-->" accesskey="3"><!--{3|numeric_emoji}-->同意しない<br>
