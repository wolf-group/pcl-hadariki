...
<!--{if !$tpl_cart_empty}-->
<a href="<!--{$smarty.const.MOBILE_SITE_URL}-->shopping/deliv.php?transactionid=<!--{$smarty.get.transactionid}-->&PHPSESSID=<!--{$smarty.get.PHPSESSID}-->">ご注文手続きへ進む</a><br>
<!--{/if}-->

<a href="<!--{$smarty.const.MOBILE_URL_SITE_TOP}-->?transactionid=<!--{$smarty.get.transactionid}-->&PHPSESSID=<!--{$smarty.get.PHPSESSID}-->" accesskey="0"><!--{0|numeric_emoji}-->TOPページに戻る</a><br>
