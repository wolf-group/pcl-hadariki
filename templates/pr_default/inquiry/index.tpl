...
<!--▲TITLE-->
<table width="760" border="0" cellspacing="0" cellpadding="0" align="center" summary=" ">
	<tr>
	...
	<tr>
		<td bgcolor="#7e7e7e"><img src="../misc/_.gif" width="10" height="1" alt=""></td>
	</tr>
	...
	<tr>
		...
		<table width="600" border="0" cellspacing="0" cellpadding="0" summary=" ">
			...
			<!--<tr><td height="10"></td></tr>-->
			<!--{if $errmsg}--><tr><td class="fs12n"><span class="red0"><br>入力エラーが発生致しました。各項目のエラーメッセージをご確認の上、正しく入力してください。</span></td></tr><!--{/if}-->	
			<tr>
				<td bgcolor="#7e7e7e">
			...
			<tr>
				<td class="fs12n"><span style="color:#ff0000;">※印は入力必須項目です。</span></td>
			</tr>
			...
			<tr>
				...
				<table width="600" border="0" cellspacing="1" cellpadding="10">
					...
					<tr>
						<td class="fs12n" bgcolor="#ebf9ff" width="150"><span style="color:#ff0000;">※</span>お名前</td>
					...
					<tr>
						<td class="fs12n" bgcolor="#ebf9ff" width="150"><span style="color:#ff0000;">※</span>フリガナ</td>
						<td class="fs12n" bgcolor="#ffffff" width="407">
					...
					<tr>
						<td class="fs12n" bgcolor="#ebf9ff" width="150"><span style="color:#ff0000;">※</span>郵便番号</td>
					...
					<tr>
						<td class="fs12n" bgcolor="#ebf9ff" width="150"><span style="color:#ff0000;">※</span>ご住所</td>
						<td bgcolor="#ffffff">
						<table width="407" border="0" cellspacing="0" cellpadding="0" summary=" ">
							<tr>
					...
					<tr>
						<td class="fs12n" bgcolor="#ebf9ff" width="150"><span style="color:#ff0000;">※</span>お電話番号</td>
						<td class="fs12n" bgcolor="#ffffff" width="407">
					...
					<tr>
						<td class="fs12n" bgcolor="#ebf9ff" width="150"><span style="color:#ff0000;">※</span>メールアドレス</td>
						<td bgcolor="#ffffff">
