            ...
            <tr valign="top">
                ...
                <table cellspacing="1" cellpadding="10" summary=" " id="frame">
                    ...
                    <tr class="fs12n">
                        ...
                        <!--{assign var=price02_min value=$arrForm|@reduce_tax_min_price_from_product:$arrSiteInfo:$smarty.session.customer.customer_id:$smarty.section.cnt.index}-->
                        <!--{assign var=price02_max value=$arrForm|@reduce_tax_max_price_from_product:$arrSiteInfo:$smarty.session.customer.customer_id:$smarty.section.cnt.index}-->
                        <td class="left04w">
                        <!--{if $price02_min == $price02_max}-->
                        <!--{$price02_min|number_format|escape}-->
                        <!--{else}-->
                        <!--{$price02_min|number_format|escape}-->　<br/>〜<br/><!--{$price02_max|number_format|escape}-->
                        <!--{/if}-->
                        円</td>
                    </tr>
                    <!--{/section}-->
