	...
	<tr>
		...
		<table cellspacing="0" cellpadding="0" summary=" " id="containerfull">
			...
			<tr valign="top">
				...
				選択後、一番下の「注文を確定する」ボタンをクリックしてください。</div>
				...
				<div class="red12" id="comment02">※「注文を確定する」をクリック後、完了ページが表示されるまでお待ちください。</div>
				...
				<ul class="btn_area_n2">
					...
					<li class="btn">
						<span class="btn_next">
							<a href="javascript:void(0);" onclick="document.form1.submit();">注文を確定する<input type="hidden" name="complete" id="complete" /></a>
						</span>
					</li>
				</ul>
