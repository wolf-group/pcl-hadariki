	...
	<tr>
		...
		<table cellspacing="0" cellpadding="0" summary=" " id="containerfull">
			...
			<tr valign="top">
				...
				<td>
				<div class="head">
					<h2 class="t_cresit">クレジットカード決済</h2>
				</div>
				...
				<table cellspacing="1" cellpadding="8" summary=" " id="frame">
					<tr>
						...
						<td id="right"><img src="../img/shopping/card.gif" alt="ご利用可能なカードの種類" title="ご利用可能なカードの種類" /></td>
					</tr>
					<tr>
				...
				<div id="button">
				<!--「戻る」「登録」-->
				<a href="<!--{$smarty.server.PHP_SELF|escape}-->" onmouseover="chgImg('/img/button/back03_on.gif','back03')" onmouseout="chgImg('/img/button/back03.gif','back03')" onclick="history.back(); return false;" /><img src="/img/button/back03.gif" alt="前のページへ戻る" title="前のページへ戻る" border="0" name="back03" id="back03" ></a><img src="../img/_.gif" width="12" height="" alt="" />
				<input type="image" onmouseover="chgImgImageSubmit('../img/shopping/complete_on.gif',this)" onmouseout="chgImgImageSubmit('../img/shopping/complete.gif',this)" src="../img/shopping/complete.gif" alt="ご注文完了ページへ" title="ご注文完了ページへ" border="0" name="complete" id="complete" />
				</div>
				</form>
