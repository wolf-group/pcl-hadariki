...
<a href="kiyaku.php?page=<!--{$tpl_kiyaku_index-1}-->&transactionid=<!--{$smarty.get.transactionid}-->" accesskey="1"><!--{1|numeric_emoji}-->戻る</a><br>
<!--{/if}-->
<!--{if !$tpl_kiyaku_is_last}-->
<a href="kiyaku.php?page=<!--{$tpl_kiyaku_index+1}-->&transactionid=<!--{$smarty.get.transactionid}-->" accesskey="2"><!--{2|numeric_emoji}-->進む</a><br>
<!--{/if}-->
<!--{/if}-->
