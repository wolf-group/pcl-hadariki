<div id="entrycolumn">
	<div class="entry_inner">
		...
		<form name="form1" id="form1" method="post" action="<!--{$smarty.server.PHP_SELF|escape}-->">
			...
			<div class="entry_info">
				<ul>
					...
					<li class="entry_info_inner02">
						...
						〒&nbsp;<input type="text" name="zip01" value="<!--{if $zip01 == ""}--><!--{$arrOtherDeliv.zip01|escape}--><!--{else}--><!--{$zip01|escape}--><!--{/if}-->" maxlength="<!--{$smarty.const.ZIP01_LEN}-->" style="<!--{$arrErr.zip01|sfGetErrorColor}-->;" size="6" class="box60"  autocomplete="off" inputmode="numeric"/>&nbsp;-&nbsp;<input type="text" name="zip02" value="<!--{if $zip02 == ""}--><!--{$arrOtherDeliv.zip02|escape}--><!--{else}--><!--{$zip02|escape}--><!--{/if}-->" maxlength="<!--{$smarty.const.ZIP02_LEN}-->" style="<!--{$arrErr.zip02|sfGetErrorColor}-->;" size="6" class="box60"  autocomplete="off" inputmode="numeric"/>&nbsp;
					...
					<li class="entry_info_inner02">
						...
						<input type="text" name="tel01" size="6" value="<!--{$tel01|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" class="box60" style="<!--{$arrErr.tel01|sfGetErrorColor}-->;" inputmode="numeric"/>&nbsp;-&nbsp;<input type="text" name="tel02" size="6" value="<!--{$tel02|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.tel02|sfGetErrorColor}-->;" class="box60" inputmode="numeric" />&nbsp;-&nbsp;<input type="text" name="tel03" size="6" value="<!--{$tel03|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.tel03|sfGetErrorColor}-->;" class="box60" inputmode="numeric" />
					</li>
					<li class="entry_info_head">FAX</li>
					<li class="entry_info_inner02">
						<span class="attention"><!--{$arrErr.fax01}--><!--{$arrErr.fax02}--><!--{$arrErr.fax03}--></span>
						<input type="text" name="fax01" size="6" value="<!--{$fax01|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.fax01|sfGetErrorColor}-->;" class="box60" autocomplete="off" inputmode="numeric"/>&nbsp;-&nbsp;<input type="text" name="fax02" size="6" value="<!--{$fax02|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.fax02|sfGetErrorColor}-->;" class="box60"  autocomplete="off" inputmode="numeric"/>&nbsp;-&nbsp;<input type="text" name="fax03" size="6" value="<!--{$fax03|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.fax03|sfGetErrorColor}-->;" class="box60"  autocomplete="off" inputmode="numeric"/>
					</li>
                    <li class="entry_info_head">メールアドレス<span class="attention">※</span></li>
                    <li class="entry_info_inner02">
                        <span class="attention"><!--{$arrErr.email}--></span>
                        <div>
                            <input type="text" name="email" size="36" value="<!--{$email|escape}-->" style="<!--{$arrErr.email|sfGetErrorColor}-->;"  autocomplete="off" inputmode="email"/>
                        </div>
                    </li>
			...
			<ul>
				<li class="sp_btn">
					<a href="javascript:void(0);" onclick="document.form1.submit();">確認ページへ</a><input type="hidden" name="confirm" id="confirm" />
				</li>
			</ul>
		</form>
	</div>
