                                ...
                                <div id="regular_detail_<!--{$arrOrder[cnt].order_id}-->" style="display:none;margin: 10px 0 0 0;">
                                    <div class="rebular_dtbox">
                                        ...
                                        <div class="mypage_regtotal">
                                          ...
                                          <span class="mg_changebt next_info_btn" data-id="<!--{$arrOrder[cnt].order_id|escape}-->" style="text-align: center; margin: 0.5rem;"><a>次回お支払い合計金額</a></span>
                                        </div>
                                    </div>
                                        <div class="mypage_regtotal" id="next_info_blk_<!--{$arrOrder[cnt].order_id|escape}-->" style="display:none;">
                                            <table summary="購入商品詳細">
                                                <tbody>
                                                    ...
                                                    <!--{/if}-->
                                                    <tr class="totalbg">
                                                        <td colspan="3" class="righttd">次回お支払い<br>合計金額</td>
