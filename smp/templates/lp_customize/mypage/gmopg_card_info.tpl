                ...
                <!--{foreach from=$arrSavedCardInfo item=card_info key=payment_wallet_id name=card_info}-->
                    <table>
                        ...
                        <tr>
                            <th>カード名義</th>
                            <td>
                                <!--{$card_info.holder_name|escape}-->
                            </td>
                        </tr>
                    </table>    
                    <ul>
                        <li class="mg_cardbtn">
                        <a href="#" class="edit-card-info" data-payment-wallet-id="<!--{$payment_wallet_id|escape}-->">カード情報を変更する</a>
                        </li>
                    </ul>
                <!--{/foreach}-->
                    ...
                    <ul class="btnbox">
                        ...
                        <a href="./gmopg_change_card_info.php">カード情報の新規登録はこちらから</a>
                        </li>
                    </ul>
                    <!--{/if}-->
                <!--{else}-->
