                ...
                <dd>
                   <div class="lp_detail">
                    　<ul>
                        ...
                        <!--{* 数量は適宜編集してください。*}-->
                        <li class="w30" style="display: none;">
                            <p class="sp_ftb">数量</p>
                            <div class="custom-select w100">
    ...
    <div id="lp-shop-name">会員の方はこちら</div>
        ...
        <dl class="lp-not-login" id="lp-not-login"<!--{if $register == 1}--> style="display:none;"<!--{/if}-->>
            ...
            <div id="payment_area" class="smp-lp-section" style="display:none;">
                <h3>お支払方法</h3>
                <div>
                    <p style="margin-bottom: 15px;">クレジットカード払いとコンビニでお支払いできるNP後払いが利用できます。</p>
                    <img src="https://hadariki.preciouscosme.com/upload/save_image/11180859_61959755e53d5.png" style="max-width:100%">
                </div>
        ...
        <div class="smp-lp-section" id="deliv_datetime_area" style="display:none;">
            <h3 style="display:none;">お届け希望日時</h3>
            <!--{* ↓このspan内にお届け時間関連が表示されます。デザイン変更はlp_ajax.tplを編集してください。↓ *}-->
            <div id="deliv_time_area" style="display:none;"></div>
            <!--{* ↑このspan内にお届け時間関連が表示されます。デザイン変更はlp_ajax.tplを編集してください。↑ *}-->
        </div>
        ...
        <div class="smp-lp-section">
            ...
            <dl>
                ...
                <dd class="ft_bold" style="display: none;">
                ...
                <dd>
                    ...
                    <div class="ft_bold" style="display: none;">
                      <input type="checkbox" checked="checked" name="agree" value="1" id="agree" class="chbox" />
        ...
        <div class="smp-lp-bottomline">
            <div class="smp-lp-section">
                <div class = "step-area" style="margin-bottom: 35px;">
                    <div class="step-section active">
                        <section class = "step-circle ">
                            <span class = "step-circle-text">STEP<br>1</span>
                        </section>
